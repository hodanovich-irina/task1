        ...
        public override ChessFigure FigureLogic(int j, int i, int y, int x, ChessFigure[,] board, List<ChessFigure> chessFiguresBlack, List<ChessFigure> chessFiguresWhite)
        {
            ...
            if (i != x && j == y && (newBoard[i, j].Color == Color.black || newBoard[i, j].Color == Color.white))
            {
                if (newBoard[x, y] == null)
                {
                    ...
                    if (k == true)
                    {
                        Logger.Write("The queen walked (from [" + j.ToString() + ", " + i.ToString() + "] to [" + y.ToString() + ", " + x.ToString() + "])!");
                    ...
                    {
                        Logger.Write("A queen can't walk like that(from [" + j.ToString() + ", " + i.ToString() + "] to [" + y.ToString() + ", " + x.ToString() + "])!");
                        res = newBoard[x, y];
                    }
                }
                else
            ...
            else if (Math.Abs(x - i) == Math.Abs(y - j) && (newBoard[i, j].Color == Color.black || newBoard[i, j].Color == Color.white))
            {
